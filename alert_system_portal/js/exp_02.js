...
var goes16fires = new L.GeoJSON.AJAX("data_map/exp_02/pts_fdc.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#ff6347",
...
// .addTo(map)
var goes16smoke = new L.GeoJSON.AJAX("data_map/exp_02/pts_adpS.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#808080",
...
// .addTo(map)
var goes16dust = new L.GeoJSON.AJAX("data_map/exp_02/pts_adpD.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#ffa500",
...
// .addTo(map)
var goes16prec = new L.GeoJSON.AJAX("data_map/exp_02/pts_rrqpef.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#1e90ff",
