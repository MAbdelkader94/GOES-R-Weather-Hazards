...
var rfcslyr = new L.GeoJSON.AJAX("data_map/rfcs.geojson", {
    style: {
      "color": "#000000",
      "weight": 1.5,
      "opacity": 0.95,
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup(feature.properties.STUSPS + ' | ' + feature.properties.NAME);
  
    }
  });
  var femalyr = new L.GeoJSON.AJAX("data_map/fema.geojson", {
    style: {
      "color": "#ff0000",
      "weight": 1.5,
      "opacity": 0.95,
...
var goes16fires = new L.GeoJSON.AJAX("data_map/exp_03/pts_fdc.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#ff6347",
...
// .addTo(map)
var goes16smoke = new L.GeoJSON.AJAX("data_map/exp_03/pts_adpS.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#808080",
...
// .addTo(map)
var goes16dust = new L.GeoJSON.AJAX("data_map/exp_03/pts_adpD.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#ffa500",
...
// .addTo(map)
var goes16prec = new L.GeoJSON.AJAX("data_map/exp_03/pts_rrqpef.geojson", {
    style: {
        weight: 2,
        opacity: 1,
        color: "#1e90ff",
